        ...
        <div className="container grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div className="animate-reveal-up">
            ...
            <p className="mt-6 leading-8 text-muted-foreground">
              VJ International Certifications provides ISO certification support. The company helps organizations prepare documentation, coordinate audit readiness, manage certification applications, and maintain clear verification records.
            </p>
